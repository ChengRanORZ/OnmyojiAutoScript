...
class RyouToppaAssets: 
	...
	# Image Rule Assets
	# 寮突 
	I_RYOU_TOPPA = RuleImage(roi_front=(1190,340,78,140), roi_back=(1190,340,90,140), threshold=0.6, method="Template matching", file="./tasks/RyouToppa/res/res_ryou_toppa.png")
	# 寮突选择阴阳寮按钮 
